package cn.meteor.opencode.platform.util;
...
//        InputStream uploadedStream = new FileInputStream(file1);
...
//        File dfile = new File(file.getOriginalFilename());
...
//        InputStream uploadedStream = new FileInputStream(dfile);
//
//        HashMap<String, InputStream> files = new HashMap<String, InputStream>();
//        files.put("smfile", uploadedStream);
//        String line = uploadToFarService(files);
